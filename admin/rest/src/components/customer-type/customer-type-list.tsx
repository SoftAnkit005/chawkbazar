...
import { CustomerType, SortOrder } from "@ts-types/generated";
...
const CustomerTypeList = ({ customerTypes, onSort, onOrder }: IProps) => {
	...
	let columns = [
		...
		// 		<ActionButtons
		// 			id={id}
		// 			editUrl={`${router.asPath}/${id}/edit-customer-type`}
		// 		/>
		// 	),
		// },
	];
