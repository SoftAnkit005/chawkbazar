...
const ConfirmationApproveCard: React.FC<ConfirmationCardProps> = ({
  onCancel,
  onApprove,
  icon,
  title = "Approve",
      ...
      <div className="w-full h-full text-center">
        <div className="flex h-full flex-col justify-between">
          {icon ? (
            ...
            <UploadIcon className="mt-4 w-12 h-12 m-auto text-accent" />
          )}
...
export default ConfirmationApproveCard;
