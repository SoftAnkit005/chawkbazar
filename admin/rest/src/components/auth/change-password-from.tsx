...
const ChangePasswordForm = () => {
  ...
  return (
    <form noValidate onSubmit={handleSubmit(onSubmit)}>
      ...
      <span style={{background:"red", margin:"10px", padding:"15px 20px", color:"white", borderRadius:"5px", fontSize:"16px", fontWeight:"bold"}} onClick={handleDelete}>Delete Account</span>
