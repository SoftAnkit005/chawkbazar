...
const ProductService = new CoreApi(API_ENDPOINTS.NONSOLITAIRE_PRODUCTS);
...
const useProductsInfiniteQuery = (
  ...
  return useInfiniteQuery<PaginatedProduct, Error>(
    [API_ENDPOINTS.NONSOLITAIRE_PRODUCTS, params],
...
export const useNonSolitaireProductsQuery = (options: ProductsQueryOptionsType) => {
  return useQuery<{ data: Product[] }, Error>(
    [API_ENDPOINTS.NONSOLITAIRE_PRODUCTS, options],
    fetchProducts
  );
};
...
export const useProductQuery = (slug: string) => {
  return useQuery<Product, Error>([API_ENDPOINTS.NONSOLITAIRE_PRODUCTS, slug], () =>
    fetchProduct(slug)
  );
};
