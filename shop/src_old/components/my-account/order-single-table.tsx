...
const OrderSingleTable: React.FC<Props> = ({ order }) => {
  ...
  return (
    <tr className="border-b border-gray-300 last:border-b-0">
      <td className="px-1 py-5 ltr:text-left rtl:text-right">
        <Link
      ...
      <td className="ltr:text-left rtl:text-right lg:text-center px-6 py-5 text-heading">
      ...
      <td className="ltr:text-left rtl:text-right lg:text-center px-4 py-5 text-heading">
        {itemTotal.split(".")[0]} for {order.products.length} items
      </td>
