...
const data = {
	...
	supportImage: "https://zweler.com/admin/assets/images/support.png",
};
...
const Support: React.FC<Props> = ({ className }) => {
	...
	return (
		...
		>
			...
			<Button style={{ background: '#5d6b6b' }}>
				<a href="https://api.whatsapp.com/send?phone=%2B919624177111&data_filter_required=ARByqWNLVfROZVrx-i2ctLl6ebcUidcU58MX2MvEGOwxBUXg5pYzv-0YCCCcSETx7nHh1hlil0izUmpexI4v3eQJUsDe710O4NGUPmIttfWXdc3dFsOgBx3wYBUxA7lO-MrktxtpCNVksVsRUtA1idhKSA&source=FB_Page&app=facebook&entry_point=page_cta&fbclid=IwAR3tXPUyEQe-n8cZgPGewH0QaSJrESMCo1my35n34lMpFGrfZc3BdKWK6ss" target="_blank" rel="noreferrer" className="flex">
					{t(`${buttonText}`)}
