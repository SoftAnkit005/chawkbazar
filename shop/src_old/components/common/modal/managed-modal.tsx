...
const DeleteAccount = dynamic(() => import("@components/my-account/account-delete"));
const DeleteAccountConfirmed = dynamic(() => import("@components/my-account/account-delete-confirmed"));
...
const LuckyForm = dynamic(() => import("@components/my-account/lucky-form"));
const LuckyFormSubmited = dynamic(() => import("@components/my-account/lucky-form-submited"));
...
const ManagedModal: React.FC = () => {
  ...
  return (
    <Modal open={displayModal} onClose={closeModal} variant={modalVariant}>
      {modalView === "DELETE_ACCOUNT_VIEW" && <DeleteAccount />}
      {modalView === "DELETE_ACCOUNT_CONFIRMED_VIEW" && <DeleteAccountConfirmed />}
      {modalView === "LUCKY_FORM_VIEW" && <LuckyForm />}
      {modalView === "LUCKY_FORM_SUBMITED_VIEW" && <LuckyFormSubmited />}
