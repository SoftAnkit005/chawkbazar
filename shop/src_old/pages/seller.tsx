...
import { SellerPolicy } from "@settings/seller-settings";
...
export default function SellerPage() {
  ...
  return (
    <>
      <PageHeader pageHeader="text-page-seller-policy" />
...
SellerPage.getLayout = getLayout;
