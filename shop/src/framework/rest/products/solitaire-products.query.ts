...
const ProductService = new CoreApi(API_ENDPOINTS.SOLITAIRE_PRODUCTS);
...
const useProductsInfiniteQuery = (
  ...
  return useInfiniteQuery<PaginatedProduct, Error>(
    [API_ENDPOINTS.SOLITAIRE_PRODUCTS, params],
...
export const useSolitaireProductsQuery = (options: ProductsQueryOptionsType) => {
  return useQuery<{ data: Product[] }, Error>(
    [API_ENDPOINTS.SOLITAIRE_PRODUCTS, options],
    fetchProducts
  );
};
...
export const useProductQuery = (slug: string) => {
  return useQuery<Product, Error>([API_ENDPOINTS.SOLITAIRE_PRODUCTS, slug], () =>
    fetchProduct(slug)
  );
};
