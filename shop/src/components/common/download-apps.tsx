...
const data = {
  ...
  appImage: "https://zweler.com/admin/assets/images/app.png",
  appButtons: [
    {
      id: 1,
      slug: "/#",
      altText: "button-app-store",
      appButton: "https://zweler.com/admin/assets/images/app-store.png",
      buttonWidth: 209,
      buttonHeight: 60,
    },
    {
      ...
      appButton: "https://zweler.com/admin/assets/images/play-store.png",
      buttonWidth: 209,
      buttonHeight: 60,
    },
  ],
