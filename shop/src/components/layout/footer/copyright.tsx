...
const Copyright: React.FC<CopyrightProps> = ({ payment }) => {
  ...
  return (
    <div className="border-t border-gray-300 pt-5 pb-16 sm:pb-20 md:pb-5 mb-2 sm:mb-0" style={{ background: '#2f3737 '}}>
      <Container className="flex flex-col-reverse md:flex-row text-center md:justify-between">
        <p className="text-xs md:text-[13px] lg:text-sm leading-6" style={{ color: '#f1f7f7 !important' }}>
          {t("text-copyright")} &copy; {year}&nbsp;&nbsp;
          {siteSettings.author.name}&nbsp; Powered by &nbsp;
          <a
