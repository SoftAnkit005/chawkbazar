                    ...
                    <div ref={ref} className="keen-slider w-[90%]">
                        {labFilterItems?.map((item,index) => 
                            <div>
                                ...
                                <label className="keen-slider__slide border border-[#fff] rounded-lg  hover:border-[#24182E] p-2 number-slide1 flex flex-col items-center justify-center py-3 2xl:py-5" htmlFor={`labcb${index}`}> <p className="font-semibold text-sm">{item.name}</p> </label>
                            </div>
                        )}
                    </div>
                    <>
