    ...
    return (
        <>
            ...
            <div className="text-center border border-gray-300 border-t-0 py-5 flex items-center justify-center">
                <p className="text-black text-base font-bold">Fluores <br /> -cence</p>
            </div>
                    ...
                    <div ref={ref} className="keen-slider w-[90%]">
                        {fluorescenceFilterItems?.map((item,index) => 
                            <>
                                ...
                                <label className="keen-slider__slide border border-[#fff] rounded-lg  hover:border-[#24182E] p-2 number-slide1 flex flex-col items-center justify-center py-3 2xl:py-5" htmlFor={`fluorescencecb${index}`}> <p className="font-semibold text-sm">{item.name}</p> </label>
                            </>
                        )}
                    </div>
                    <>
