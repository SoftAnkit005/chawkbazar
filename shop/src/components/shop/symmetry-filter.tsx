    ...
    return (
        <div className="text-center border border-gray-300 border-t-0 p-5 col-span-4">
            <div className="block mx-auto rounded-lg">
                <h3 className="text-black text-base font-bold text-center"> {"Symmetry"} </h3>
                <div className="mt-5 flex flex-col space-y-4">
                    <div className="flex items-center justify-center">
                        ...
                        />
                        <button className="text-xs py-1 px-2 ml-2 focus:outline-none shadow-md" onClick={clearSymmetryFilter} >
