...
const banner = {
	...
	image: {
		mobile: {
			url: "https://zweler.com/admin/assets/images/banner/banner-mobile-2.jpg",
			width: 450,
			height: 150,
		},
		desktop: {
			url: "https://zweler.com/admin/assets/images/banner/banner-2.jpg",
			width: 1190,
			height: 450,
		},
	},
...
const FlashSaleBlock: React.FC<Props> = ({
  ...
  const {
    ...
    isLoading: loading,
    error,
  }: any = useNonSolitaireProductsQuery({
    limit,
    status:"publish",
