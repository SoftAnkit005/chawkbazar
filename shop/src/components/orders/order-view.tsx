      ...
      <div className="w-full mx-auto shadow-sm">
        ...
        <div className="grid gap-4 lg:gap-5 sm:grid-cols-2 lg:grid-cols-4 mb-11">
          <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
            ...
            <p className="text-sm text-body"><b>Sipping Agent: </b>{order?.courier ? order.courier : "Update on Dispatch"}</p>
          </div>
          <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
            <h3 className="mb-2 text-base text-heading font-semibold">
              {t("text-date")}
            ...
            <p className="text-sm text-body"><b>OrderId: </b>ZWE-{order?.id}</p>
          </div>
          <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
            <h3 className="mb-2 text-base text-heading font-semibold">
              {t("text-total")}
          ...
          <div className="p-5 md:p-6 border border-gray-100 bg-gray-200 rounded-md shadow-sm">
            ...
            <p className="text-sm text-body">
            {order?.payment_gateway === "CASH_ON_DELIVERY" ? "Booked Order" : (order?.payment_gateway ?? "N/A")}
            </p>
          </div>
        </div>
          ...
          <div className="w-full md:w-1/2 ltr:md:pr-3 rtl:md:pl-3 border-r px-5 lg:px-7 py-6 lg:py-7 xl:py-8 border-gray-100">
            ...
            <div className="space-y-4 lg:space-y-5">
              <p className="flex text-body text-sm lg:text-[15px] xl:text-base mb-0">
                ...
                :<span className="w-1/2 md:w-8/12 ltr:pl-7 rtl:pr-7">{sub_total.split(".")[0]}</span>
              </p>
              <p className="flex text-body text-sm lg:text-[15px] xl:text-base mb-0">
                <strong className="w-1/2 md:w-4/12 ltr:pr-4 rtl:pl-4 text-heading font-semibold">
                  {t("text-shipping-charge")}
                </strong>
                :<span className="w-1/2 md:w-8/12 ltr:pl-7 rtl:pr-7">{shipping_charge.split(".")[0]}</span>
              </p>
              <p className="flex text-body text-sm lg:text-[15px] xl:text-base mb-0">
                <strong className="w-1/2 md:w-4/12 ltr:pr-4 rtl:pl-4 text-heading font-semibold">
                  {t("text-tax")}
                </strong>
                :<span className="w-1/2 md:w-8/12 ltr:pl-7 rtl:pr-7">{tax.split(".")[0]}</span>
              </p>
              <p className="flex text-body text-sm lg:text-[15px] xl:text-base mb-0">
                <strong className="w-1/2 md:w-4/12 ltr:pr-4 rtl:pl-4 text-heading font-semibold">
                  {t("text-discount")}
                </strong>
                :<span className="w-1/2 md:w-8/12 ltr:pl-7 rtl:pr-7">{discount.split(".")[0]}</span>
              </p>
              <p className="flex text-body text-sm lg:text-[15px] xl:text-base mb-0">
                <strong className="w-1/2 md:w-4/12 ltr:pr-4 rtl:pl-4 text-heading font-semibold">
                  {t("text-total")}
                </strong>
                :<span className="w-1/2 md:w-8/12 ltr:pl-7 rtl:pr-7">{total.split(".")[0]}</span>
              </p>
            </div>
          </div>
          {/* end of total amount */}
