...
function handleDelete(){
  setModalView("DELETE_ACCOUNT_VIEW");
  return openModal();
}
  return (
    <AccountLayout>
      ...
      <button style={{background:"red", margin:"20px", padding:"10px", color:"white", borderRadius:"5px", fontSize:"12px", fontWeight:"bold"}} onClick={handleDelete}>Delete Account</button>
      </div>
    </AccountLayout>
  );
}
