...
export default function ProductPage({ product }: any) {
  ...
  product.type.name !== "SOLITAIRES" ?
      ...
      : <div style={{position:"absolute",top:"40%", left:"20%", fontStyle:"bolder", fontSize:"20px"}}>
        Solitaire Products Can Only be visible in search table
      </div>
}
    </>
  );
