...
class UpdateCouponRequest extends FormRequest
{
    ...
    public function rules()
    {
        return  [
            ...
            'usagePerUser'  => ['required', 'numeric'],
            'totalUsage'    => ['required', 'numeric'],
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'usagePerUser.required'      => 'Usage Per User field is required',
            'totalUsage.required'  => 'Total Usage field is required',
